...
export const SCALES: Scale[] = [
  ...
  { id: "natural-minor", label: "Natural minor (Aeolian)", group: "Scales", offsets: [0, 2, 3, 5, 7, 8, 10] },
  { id: "harmonic-minor", label: "Harmonic minor", group: "Scales", offsets: [0, 2, 3, 5, 7, 8, 11] },
